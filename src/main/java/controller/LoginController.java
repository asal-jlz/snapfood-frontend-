            ...
            client.sendAsync(request, HttpResponse.BodyHandlers.ofString())
                    .thenAccept(response -> {
                        if (response.statusCode() == 200) {
                            ...
                            if (role.equals("seller") || role.equals("vendor")) {
                                ...
                                Platform.runLater(() -> {
                                    try {
                                        ...
                                        controller.CourierDashboardController courierCtrl = loader.getController();
                                ...
                                Platform.runLater(() -> {
                                    try {
                                        ...
                                        Parent root = loader.load();
                                        controller.BuyerDashboardController buyerCtrl = loader.getController();
        ...
        try {
            ...
            client.sendAsync(req, HttpResponse.BodyHandlers.ofString())
                    .thenAccept(response -> {
                        if (response.statusCode() == 200) {
                            try {
                                ...
                                if (jsonNode.isArray() && jsonNode.size() > 0) {
                                    ...
                                    // Optionally show alert here about missing restaurant
                                }
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
                        ...
                        // Only set session and load dashboard after restaurantId is set (or at least attempted)
                        Session.setCurrentSeller(seller);
                        Session.setUser(seller);
